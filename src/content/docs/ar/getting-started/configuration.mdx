...
### خطأ "This operation requires the FTS Admin permission set" مستمر

**العرض:** عند نشر تكوين في Configuration Wizard (تحديد كائن والنقر على **Deploy Settings**)، يظهر الخطأ **"This operation requires the FTS Admin permission set"** — رغم أن مجموعة الأذونات **Flexible Team Share - Admin** قد تم تعيينها بالفعل للمستخدم.

**السبب:** هذه إحدى خصوصيات تخزين الأذونات المؤقت في Salesforce. بعد تعيين مجموعة أذونات، يستمر Salesforce أحيانًا في التقييم بناءً على حالة الأذونات السابقة للمستخدم خلال الجلسة النشطة، لذا لا يتم التعرف على الوصول الممنوح حديثًا على الفور.

**الحل:**
<Steps>
1. تأكد من أن مجموعة الأذونات **Flexible Team Share - Admin** (أو Admin Permission Set Group) معينة للمستخدم ضمن **Setup** > **Permission Set Groups** / **Permission Sets**
2. قم بإجراء تحديث كامل (hard refresh) في المتصفح لإجبار Salesforce على إعادة تقييم الأذونات:
...
3. إذا استمر الخطأ، قم بتسجيل الخروج ثم إعادة تسجيل الدخول لبدء جلسة جديدة
4. أعد محاولة إجراء **Deploy Settings** — يجب أن تنجح العملية الآن
</Steps>
