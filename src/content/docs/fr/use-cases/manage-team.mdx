...
Voir le [guide de configuration](/fr/getting-started/configuration/#synchronisation-du-changement-de-propriétaire) pour les instructions de configuration détaillées.
