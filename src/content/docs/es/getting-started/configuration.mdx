...
**Solución:**
<Steps>
1. Verifique que el conjunto de permisos **Flexible Team Share - Admin** (o el Admin Permission Set Group) esté asignado al usuario en **Setup** > **Permission Set Groups** / **Permission Sets**
2. Realice una recarga forzada en el navegador para obligar a Salesforce a reevaluar los permisos:
...
3. Si el error persiste, cierre sesión y vuelva a iniciar sesión para comenzar una sesión nueva
4. Vuelva a intentar la acción **Deploy Settings** — la operación ahora debería completarse correctamente
</Steps>
