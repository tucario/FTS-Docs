...
slug: 1.0/use-cases/initial-setup
---
...
* FTS\_App\_Access permission set assigned
...
![Configuration Wizard](../../../../assets/pictures/1.0/config-wizard.png)
...
* Admin access
* Expired team members exist (End\_Date\_\_c in past)
...
![Lightning App Builder configuration](../../../../assets/pictures/1.0/app-builder-config.png)
