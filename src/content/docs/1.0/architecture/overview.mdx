...
* **ObjectTeamMember\_\_c** — stores team member assignments
* **Team\_Sharing\_Config\_\_c** — per-object sharing configuration
* **FlexiTeamShare\_Config\_\_mdt** — app-level configuration (Custom Metadata)
