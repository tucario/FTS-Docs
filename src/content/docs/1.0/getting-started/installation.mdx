...
slug: 1.0/getting-started/installation
---
...
![Sharing Settings in Setup](../../../../assets/pictures/1.0/install-guide-3.png)

## Installation from AppExchange

![AppExchange installation screen](../../../../assets/pictures/1.0/install-guide-2.png)
...
<Steps>
  ...
  2. Click on **Flexible Team Share - Admin** or **Flexible Team Share - User**
     ...
     ![Permission Set Groups list](../../../../assets/pictures/1.0/install-guide-4.png)

  3. Click **Manage Assignments** > **Add Assignments**

  4. Select the users and click **Next** > **Assign**

     ![Assigning users to Permission Set Group](../../../../assets/pictures/1.0/install-guide-5.png)
</Steps>
...
![Permission Set Group Assignments](../../../../assets/pictures/1.0/permission-set-groups.png)
...
![Configuration Wizard](../../../../assets/pictures/1.0/install-guide-6.png)
...
![Add Configuration - Select Object](../../../../assets/pictures/1.0/install-guide-7.png)
![Add Configuration - Label](../../../../assets/pictures/1.0/install-guide-8.png)
![Add Configuration - Deploy](../../../../assets/pictures/1.0/install-guide-9.png)
![Add Configuration - Success](../../../../assets/pictures/1.0/install-guide-10.png)
...
![Active/Inactive toggle](../../../../assets/pictures/1.0/install-guide-11.png)
...
<Steps>
  ...
  2. Click the **Gear icon** > **Edit Page**
     ...
     ![Edit Page button](../../../../assets/pictures/1.0/install-guide-12.png)
  ...
  4. Drag the component to the desired location on the page
     ...
     ![Dragging component in App Builder](../../../../assets/pictures/1.0/install-guide-13.png)
...
* \[ ] Cleanup scheduled job is running (see [Configuration](/1.0/getting-started/configuration/#scheduled-job))
